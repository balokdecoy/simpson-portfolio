      ...
      <CardDeck className="customCard">
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Sprinter is a project management application built with MongoDB,
              Mongoose, Node.js, Express, Axios, and Dotenv. Create sprints, add
              employees and managers to sprints, and track development as your
              project progresses. To see app, use the following login
              credentials: Username: jsimpson Password: 1234
              <br />
              <br />
              <button
                type="button"
          ...
          <Card.Footer>
            <small>
              MongoDB, Mongoose, JavaScript, Node.js, Express, Axios
            </small>
          </Card.Footer>
        </Card>
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Weather application utilizing RESTful APIs. Incorporates
              OpenWeather API and dayJS API. Includes current weather forecast
              and 5-day forecast. Daily weather information includes current
              conditions, temperature, humidity, UV index, and wind speed.
              <br />
              <br />
              <button
                type="button"
      ...
      <CardDeck className="customCard">
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Hive is an employee directory application built in React.js,
              Axios, Node.js, and JavaScript. Designed to present React state
              functionality.
              <br />
              <br />
              <button
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Ace of Pentacles is a tarot card reading and horoscope app. Select
              either a three-card Past-Present-Future spread, a traditional
              Celtic Cross spread for deeper questions, or check your daily
              horosocpe. Utilizes a customized RESTful API.
              <br />
              <br />
              <button
                type="button"
      ...
      <CardDeck className="customCard">
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              Built in React and JavaScript, supported in the backend with a
              MongoDB database, Mongoose, Node.js, and Express. Continues to
              record user data while offline, and updates the system database
        ...
        <Card>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Exactly what it sounds like. A Command Line Interface (CLI)
              program that creates a customized README.md file based on user
              specifications.
              <br />
              <br />
              <button
